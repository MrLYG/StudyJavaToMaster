...
public class RoleController {
    ...
    public ResponseResult roleContextResource(@RequestBody RoleContextResourceVO roleContextResourceVO) {

        roleService.roleContextResource(roleContextResourceVO.getRoleId(),roleContextResourceVO.getResourceIdList());
