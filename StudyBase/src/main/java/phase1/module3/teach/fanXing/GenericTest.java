package phase1.module3.teach.fanXing;
...
//        Object o = lt3.get(0);  // ok，支持元素的获取操作，全部当做Object类型来处理
        ...
        Object ob = new Animal();
        lt5.add((Animal)ob); //只有父类对象本身就是用子类new出来的时候, 才可以在将来被强制转换为子类对象.
        //lt5.add((Animal)new Object());//java.lang.ClassCastException: java.lang.Object cannot be cast to lagou.phase1.module3.teach.fanXing.Animal
        
        Object object = lt5.get(2);
